...
///    [_compareBase]), so work that `gg do merge` put on the main branch
///    without tagging it still counts as unreleased.
///
...
class PublishSkipCheck {
  ...
  /// so everything after it is unreleased. `gg do merge` merges a ticket into
  /// the main branch *without* tagging it, so comparing against the main
