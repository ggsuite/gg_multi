...
class DoPushCommand extends DirCommand<void> {
  ...
  Future<void> get({
    ...
    await GgStatusPrinter<void>(
      ...
      () async => _checkUncommittedChanges(nodes: nodes, ggLog: taskLog),
    );
  ...
  Future<void> _mergeMainIntoRepos({
    ...
    for (final repo in nodes) {
      ...
      try {
        ...
        final result = await _processRunner(
          'git',
          <String>['merge', 'origin/$mainBranch'],
          workingDirectory: repoDir.path,
        );
  ...
  String _mergeConflictReport({
    ...
    required List<String> conflicts,
      ...
      [
        cError(
          'Merging origin/$mainBranch into $repoName produced conflicts:',
        ),
  ...
  Future<String> _currentBranch(Directory repoDir) => _runGit(
