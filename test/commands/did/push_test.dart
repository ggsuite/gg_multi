...
import 'package:kidney_core/src/commands/did/push.dart';
...
void main() {
  ...
  group('DidPushCommand (ticket-wide)', () {
    ...
    test('checks all repos successfully', () async {
      ...
      expect(
        messages,
        contains('Checking if A in ticket TICKDP was pushed...'),
      );
      expect(
        messages,
        contains('Checking if B in ticket TICKDP was pushed...'),
      );
    });
