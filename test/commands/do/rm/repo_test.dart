...
import 'package:gg_multi/src/commands/do/rm/repo.dart';
...
void main() {
  group('RemoveRepoCommand', () {
    ...
    group('invoked with --from-master', () {
      ...
      test(
          'refuses to delete the master copy when the repo is also in a '
        ...
        expect(
          messages.any((m) => m.contains('gg do rm repo shared')),
          isTrue,
        );
      });
    ...
    group('dependency chain inside a ticket', () {
      ...
      test('removes several repos dependents-first, whatever the given order',
          () async {
      ...
      test('an unknown name is reported and does not stop the others',
          () async {
